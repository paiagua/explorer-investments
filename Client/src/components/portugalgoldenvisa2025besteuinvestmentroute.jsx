            ...
            <h2 className="text-xl sm:text-3xl md:text-4xl font-bold mb-6 text-left">
              <span className="inline-flex items-start gap-3">
                ...
                <span className="leading-tight">
                  Portugal Golden Visa 2025: The Last Gateway to EU Residency as Spain Shuts Its Doors
                </span>
              </span>
            </h2>

            <div className="space-y-6 text-sm sm:text-base leading-relaxed text-justify">
              <p>As Spain permanently ends its real estate Golden Visa route in April 2025, Portugal has emerged as the top destination for global investors seeking secure, fast-track EU residency and citizenship.</p>

              <p className="font-semibold flex items-center gap-2 text-base">
                <Gavel className="w-5 h-5 text-[#B4A77E]" /> Spain Officially Ends Golden Visa Real Estate Path
              </p>
              <p>On April 3, 2025, Spain formally terminated its Golden Visa real estate investment program, following a Senate-approved law published in the Official Gazette on January 3, 2025. Prime Minister Pedro Sánchez announced the move was designed to "transform housing from speculation into a fundamental right."</p>
              <p>This leaves Portugal as the most accessible and efficient Golden Visa program in Europe.</p>

              <p className="font-semibold flex items-center gap-2 text-base">
                <TrendingUp className="w-5 h-5 text-[#B4A77E]" /> Why Portugal Is Now the #1 Golden Visa Destination in Europe
              </p>
              <ul className="list-disc ml-6 space-y-1">
                <li><strong>Investment in Regulated Funds:</strong> Minimum €500,000 - Explorer Investments is a top provider.</li>
                <li><strong>Job Creation:</strong> Create 10 full-time jobs or 8 in low-density areas.</li>
                <li><strong>Donations:</strong> €250,000 to culture or €500,000 to scientific research.</li>
              </ul>

              <p className="font-semibold flex items-center gap-2 text-base">
                <RefreshCcw className="w-5 h-5 text-[#B4A77E]" /> Portugal Golden Visa 2025: Fast, Legal, and Fully Digital
              </p>
              <ul className="list-disc ml-6 space-y-1">
                <li>Biometric appointments scheduled in 30-90 days</li>
                <li>Documents accepted in English, Spanish, or French</li>
                <li>Online transfer of pending applications</li>
              </ul>

              <p className="font-semibold flex items-center gap-2 text-base">
                <UserCheck className="w-5 h-5 text-[#B4A77E]" /> Why Global Investors Are Shifting to Portugal
              </p>
              <ul className="list-disc ml-6 space-y-1">
                <li>Legal security and political stability</li>
                <li>Attractive fund-based returns</li>
                <li>Only 7 days/year stay required</li>
                <li>Full family inclusion (spouse, kids up to 26, dependent parents)</li>
                <li>Schengen access (27 EU countries)</li>
                <li>Citizenship after 5 years (residency clock starts from application date)</li>
              </ul>

              <p className="font-semibold flex items-center gap-2 text-base">
                <FileText className="w-5 h-5 text-[#B4A77E]" /> Spotlight: Explorer Investments - Portugal’s Top Golden Visa Fund
              </p>
              <ul className="list-disc ml-6 space-y-1">
                <li>€1.8 billion AUM</li>
                <li>20+ years of private equity experience</li>
                <li>CMVM-regulated fund</li>
                <li>Institutional-grade transparency</li>
                <li>3x MOIC (Multiple on Invested Capital)</li>
                <li>65+ successful exits</li>
              </ul>
              <p className="italic">"The only fund that let me invest alongside institutions. I got returns - and EU residency."</p>

              <p className="font-semibold flex items-center gap-2 text-base">
                <Globe className="w-5 h-5 text-[#B4A77E]" /> Market Impact and Global Shift
              </p>
              <p>Between 2013-2019, 14.4% of all foreign investment in Portugal came from Golden Visa applicants. With Spain out, Portugal now absorbs the demand from:</p>
              <ul className="list-disc ml-6 space-y-1">
                <li>🇺🇸 U.S. investors post-Brexit</li>
                <li>🇨🇳 Chinese high-net-worth individuals</li>
                <li>🇧🇷 Brazilian entrepreneurs</li>
                <li>🇷🇺 Russian expats</li>
                <li>🇬🇧 British nationals seeking EU access</li>
              </ul>
            </div>
                    <div className="pb-10">
