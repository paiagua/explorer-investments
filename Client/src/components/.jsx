    ...
    <script
      ...
      dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          description:
            "A deep dive written in first‑person by André Bandeira on why CMVM‑regulated funds are now the leading route for Portugal’s Golden Visa, with Explorer Investments.",
          author: {
            '@type': 'Person',
            name: 'André Bandeira',
          ...
          mainEntityOfPage: {
            '@type': 'WebPage',
            '@id': 'https://goldenvisashub.com/why-smart-investors-choose-cmvm-regulated-funds-portugal-golden-visa-2025',
          },
      ...
      dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          mainEntity: [
            {
              '@type': 'Question',
              name: 'What is the minimum investment for Portugal’s Golden Visa via funds?',
              acceptedAnswer: {
                '@type': 'Answer',
                text: '€500,000 in a CMVM‑regulated investment fund that complies with ARI rules.',
              },
            },
            {
              '@type': 'Question',
              name: 'Can US citizens invest and qualify for the Golden Visa through funds?',
              acceptedAnswer: {
                '@type': 'Answer',
                text: 'Yes. Many funds are structured to accept US Persons and provide FATCA/PFIC reporting. Confirm eligibility with Investor Relations.',
              },
            },
            {
              '@type': 'Question',
              ...
              acceptedAnswer: {
                '@type': 'Answer',
                text: 'No. The typical stay requirement can be around seven days per year. Always verify current rules before applying.',
              },
            },
          ],
        }),
