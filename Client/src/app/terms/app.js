...
return (
  <>
    ...
    <div className="max-w-[1200px] w-[90%] mx-auto py-10">
      ...
      <p>
        The present website (
        <a href="https://goldenvisashub.com" className="text-blue-600 underline">
          https://goldenvisashub.com
        </a>
        ) (from now on “Website”) was created, belongs and is operated by Explorer Investments
        Sociedade de Capital de Risco, S.A. (from now on ‘Explorer Investments’) and is governed by these
        Terms of Use.
      </p>

      <p className="mt-4">
        The User of this website (‘User’) acknowledges that by using this website they are accepting its Terms of Use.
      </p>

      <p className="mt-4">
        Explorer Investments has the exclusive right, at all times, to suspend, either partially or totally, access to the
        website, especially in management operations; maintenance, repair, change or modernisation and close access to the
        website, either definitively or temporarily, partially or totally, at any moment.
      </p>

      <p className="mt-4">
        The content of this website is made available for the purpose of providing general information and does not constitute
        the provision of services. Explorer Investments excludes liability for any damages that may occur in connection with the
        information contained on this website. The website is merely informative.
      </p>

      <p className="mt-4">
        The User recognises that the contents of the website are protected by intellectual property rights and is obliged to
        respect these rights.
      </p>

      <p className="mt-4">
        Rights on texts, images, graphics, sound and animation and all other information and the way in which they are
        graphically represented on the website, including the brands, logos and symbols, as well as the layout and structure of
        the Website, are the property of Explorer Investments or have been rightly licensed in favour of Explorer Investments.
      </p>

      <p className="mt-4">
        Explorer Investments can make available links to pages of other institutions. These websites do not belong to nor are
        operated or controlled by Explorer Investments, so that Explorer Investments is not responsible for, does not approve of
        nor in any way supports nor subscribes to the content of these websites, nor of those linked with them or referred to in
        them. The use of these links is the entire responsibility of the Users.
      </p>

      <p className="mt-4">
        Explorer Investments authorises the temporary download and storage of the contents of the website for viewing purposes on
        a personal computer or monitor. Reproduction, permanent storage or retransmission of the contents of the website are
        expressly prohibited without the prior permission of Explorer Investments.
      </p>

      <p className="mt-4">
        Explorer Investments intends to guarantee and protect privacy and comply with its legal obligations. Our{' '}
        <a href="/policy" className="text-blue-600 underline">Privacy Policy</a> defines the processing of any personal
        information which is provided to us when you use this website. Our{' '}
        <a href="/cookie" className="text-blue-600 underline">Cookies Policy</a> describes how we use internet cookies.
      </p>
    </div>
