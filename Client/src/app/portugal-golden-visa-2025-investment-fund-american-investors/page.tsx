...
import App from '@/app/portugal-golden-visa-2025-investment-fund-american-investors/app';
...
export const metadata = {
  ...
  openGraph: {
    ...
    url: "https://goldenvisashub.com/portugal-best-country-to-retire-2025-golden-visa",
    type: "article",
    images: [
