...
import Benefits from '@/components/BenefitsAbout';
...
sendNewLeadAlertEmail({
  toName: "Maria",
  toEmail: "mcs@goldenvisashub.com",
  leadName: formdata.name,
  leadEmail: formdata.email,
  leadPhone: formdata.phone,
  leadInvestment: getpetage(ageValue),
...
return (
  ...
  <img
    src="https://goldenvisashub.com/assets/images/logoblue.png"
    alt="Explorer Logo"
    width={180}
    style={{ maxWidth: 180, width: '100%', height: 'auto', marginBottom: 20 }}
  />
  ...
  <p>
    This Privacy Policy (hereinafter the ‘Privacy Policy’) applies to the Asset Class Website and Investor
    Portal (hereinafter the ‘Digital Platforms’) belonging to Explorer Investments, and has been created for
    the purpose of publicising Explorer Investments’ handling of the personal data of Users of said
    Platforms.
  </p>
  <p className="mt-4">
    The availability of Users’ personal data implies the knowledge and acceptance of the conditions
    contained in this Privacy Policy. By using the Digital Platforms, you agree to the collection and use of
    your information as set out in this Privacy Policy.
  </p>
  <p className="mt-4">
    The terms used here have the meaning given to them in this Privacy Policy, which is complemented by the
  ...
  <p>
    The entity responsible for processing the personal data collected through the Digital Platforms is
    Explorer Investments, legal 506454584, headquartered in Largo Jean Monnet, n.º 1 - 8.º, 1269-068, in
    Lisbon, with the telephone number (+351) 213 241820.
  </p>
  <p className="mt-4">
    Users may contact Explorer Investments for any matter regarding the processing of their personal data
    referred to in this Privacy Policy, as well as the exercise of their rights mentioned therein, by e-mail
    to <a href="mailto:compliance@explorerinvestments.com" className="text-blue-600 underline">
      compliance@explorerinvestments.com
    </a> or by letter to the address of Explorer Investments.
  </p>

  <h2 className="text-xl font-semibold mt-6 mb-2">Personal Data Collected and Purpose</h2>
  <p>
    Access to and use of Digital Platforms does not imply the provision of personal data by the User.
    However, the use of certain features of the Website implies making available personal data by the User.
  </p>
  <p className="mt-4">Such data will be treated by Explorer Investments to:</p>
  <ul className="list-disc list-inside mt-2 space-y-2">
    <li>
      <strong>Contact request:</strong> processed with your consent to manage the contact established and
      provide clarifications and information requested.
    </li>
    <li>
      <strong>Application:</strong> processed for pre-contractual due diligence and management of your
      application.
    </li>
  </ul>
  ...
  <ul className="list-disc list-inside space-y-2">
    <li>User’s consent, if based on a request for contact.</li>
    <li>
      Carrying out pre-contractual procedures at the request of the holder and recruitment process
      management, if based on the submission of an application.
    </li>
  </ul>

  <h2 className="text-xl font-semibold mt-6 mb-2">Recipients of Personal Data</h2>
  <p>
    Explorer Investments may communicate the User’s personal data to contracted entities for service
    provision, maintenance of Digital Platforms, or to comply with legal obligations and court orders.
  </p>

  <h2 className="text-xl font-semibold mt-6 mb-2">Maintenance of Personal Data</h2>
  <p>
    Data is retained only for the period necessary for the purposes collected, unless a specific legal
    requirement justifies longer storage.
  </p>

  <h2 className="text-xl font-semibold mt-6 mb-2">User’s Rights</h2>
  <p>Users have the following rights:</p>
  <ul className="list-disc list-inside space-y-1 mt-2">
    <li>Right of access</li>
    <li>Right of rectification</li>
    <li>Right of deletion</li>
    <li>Right to limitation</li>
    <li>Right to portability</li>
    <li>Right of opposition</li>
    <li>Rights regarding automated decisions and profiling</li>
    <li>Right to lodge a complaint with the National Data Protection Commission</li>
  </ul>
  <p className="mt-4">
    The exercise of these rights is free of charge, except in cases of manifestly unfounded or excessive
    claims.
  </p>

  <h2 className="text-xl font-semibold mt-6 mb-2">Security</h2>
  <p>
    Explorer Investments applies its best efforts to protect the confidentiality of User’s personal
    information but cannot guarantee absolute protection against unauthorised access. Users are responsible
    for ensuring that devices used to access the Digital Platforms are secure.
  </p>

  <h2 className="text-xl font-semibold mt-6 mb-2">Acceptance of These Terms</h2>
  <p>
    By using the Digital Platforms, you agree to this Privacy Policy. Changes will be posted on this
    website.
  </p>

  <h2 className="text-xl font-semibold mt-6 mb-2">Updates and Changes</h2>
  <p>Explorer Investments may update or change this Privacy Policy. Please check regularly.</p>

  <h2 className="text-xl font-semibold mt-6 mb-2">Law and Foro</h2>
  <p>
    This Privacy Policy is governed by Portuguese law, with disputes resolved by the courts of Lisbon.
  </p>

  <p className="mt-6 italic text-gray-600">Date: November 2024</p>
</div>
