...
return (
  <>
    ...
    <div className="max-w-[1200px] w-[90%] mx-auto py-10">
      ...
      <p>
        This Cookies Policy (from now on ‘Cookies Policy’) applies to the website which belongs to Explorer
        Investments.
      </p>
      <p className="mt-4">
        The terms used here have the meaning given to them in the Terms and Conditions of Use, which
        complement this Cookies Policy.
      </p>
      <p className="mt-4">
        This site uses different types of cookies. Some cookies are placed by third party services that
        appear on our pages. We use cookies to personalize content and ads, to provide social media
        features and to analyse our traffic. We also share information about your use of our site with our
        social media, advertising and analytics partners who may combine it with other information that
        you’ve provided to them or that they’ve collected from your use of their services.
      </p>
      <p className="mt-4">
        ...
        and identify the computer used.
      </p>
      <p className="mt-4">
        The User has the possibility at any time to configure his/her computer to accept all cookies, to
        notify him/her when a cookie is issued or not to receive any cookies. The way in which he/she does
        this depends on the browser (web browser) used. Please consult the browser’s ‘Help’ function. If
        cookies are accepted, they can remain on the computer for many years unless they are deleted. If
        cookies are turned off, the User may be limited with the use of websites in general. To learn more
        about cookies, visit the website{' '}
        <a href="https://www.allaboutcookies.org" className="text-blue-600 underline">
          www.allaboutcookies.org
        </a>
        , which includes information on how to manage your settings for the various browser providers.
      </p>
      <p className="mt-4">
      ...
      <p>
        Explorer Investments may update or change this Cookie Policy, so we advise that you regularly
        consult our Policy.
      </p>

      <h2 className="text-xl font-semibold mt-6 mb-2">Law and Foro</h2>
      <p>
        This Policy is governed by Portuguese law and all disputes that may relate to it must be resolved by
        the courts of the district of Lisbon.
      </p>

      <h2 className="text-xl font-semibold mt-6 mb-2">Acceptance of These Terms</h2>
      <p>
        By using this website, you agree to the collection and use of your information as set out in this
        Cookie Policy. If Explorer Investments changes our privacy or cookie policy in any way, those changes
        will be posted on this website.
      </p>
      <p className="mt-4">
        You can at any time change or withdraw your consent from the Cookie Declaration on our website. Learn
        more about how you can contact us and how we process personal data in our{' '}
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2">Cookies Used</h2>
      <p>Your consent applies to the following domains: goldenvisashub.com</p>
    </div>
