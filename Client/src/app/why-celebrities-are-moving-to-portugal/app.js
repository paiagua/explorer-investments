...
import Benefits from '@/components/whycelebritiesaremovingtoportugal';
...
useEffect(() => {
 ...
 const phone = params.get('phone');
  ...
  Make Your Move to Europe - With Expert Support Every Step of the Way
</h2>
<p className="text-sm lg:text-base">
Take your first step toward EU citizenship - through a secure, high-potential investment with Portugal’s leading private equity fund.</p>
