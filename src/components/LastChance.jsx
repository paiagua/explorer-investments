          ...
          <h2 className="text-xl sm:text-3xl md:text-4xl font-bold mb-6 text-left">
            <span className="inline-flex items-start gap-3">
              ...
              <span className="leading-tight">
                Portugal Golden Visa 2025: Why Americans Must Act Before It’s Too Late
              </span>
            </span>
          </h2>

          <div className="space-y-6 text-sm sm:text-base leading-relaxed text-justify">
            <p>As of mid-2025, the Portugal Golden Visa remains one of the most flexible residency-by-investment options in the EU. But for Americans, the window to act may be closing rapidly.</p>

            <p>With U.S. economic volatility, global shifts, and rising EU pressure, Portugal stands out as a stable, tax-friendly destination for Americans seeking a reliable “Plan B.” But favorable conditions might not last.</p>

            <div className="space-y-6">
              <div>
                <p className="font-semibold flex items-center gap-2 text-base">
                  <ArrowDownCircle className="w-5 h-5 text-[#B4A77E]" /> Why 2025 Is a Turning Point for American Investors
                </p>
                <p>Since the 2024 U.S. elections, the dollar has weakened and inflation concerns have increased. A €500,000 investment now costs over $550,000 - and that number may grow.</p>
                <p className="flex items-start gap-2 text-sm">
                  <AlertTriangle className="w-4 h-4 text-red-600 mt-1" /> <span>Delays could make your Golden Visa significantly more expensive.</span>
                </p>
              </div>

              <div>
                <p className="font-semibold flex items-center gap-2 text-base">
                  <FileWarning className="w-5 h-5 text-[#B4A77E]" /> Political Uncertainty in Portugal: Will the Rules Change?
                </p>
                <p>Following the March 2025 government collapse, new proposals suggest increasing the 7-day stay requirement to up to 183 days/year. While not yet law, momentum is building.</p>
                <p className="flex items-start gap-2 text-sm">
                  <BadgeCheck className="w-4 h-4 text-green-600 mt-1" /> <span>Apply now and you may be grandfathered into current rules - even if they change later.</span>
                </p>
              </div>

              <div>
                <p className="font-semibold flex items-center gap-2 text-base">
                  <AlertTriangle className="w-5 h-5 text-[#B4A77E]" /> EU Pressure: Golden Visa Programs Are Disappearing
                </p>
                <p>Other countries have shut down similar programs due to EU pressure. Portugal’s program faces scrutiny and could be restricted next.</p>
              </div>

              <div>
                <p className="font-semibold flex items-center gap-2 text-base">
                  <Users className="w-5 h-5 text-[#B4A77E]" /> Why the Portugal Golden Visa Still Stands Out
                </p>
                <p>It still offers 7-day residency, family inclusion, Schengen access, and a 5-year path to citizenship. The fund route remains the most secure and compliant option for U.S. investors in 2025.</p>
              </div>

              <div>
                <p className="font-semibold flex items-center gap-2 text-base">
                  <Euro className="w-5 h-5 text-[#B4A77E]" /> Act Now - Before the Opportunity Disappears
                </p>
                <p>Apply today to lock in current rules, protect your investment from further USD depreciation, and avoid future restrictions. Grandfathering only applies to active applicants.</p>
              </div>
            </div>

            <p className="font-semibold flex items-center gap-2 pt-6 text-base">
              <BadgeCheck className="w-5 h-5 text-[#B4A77E]" /> Final Thoughts: A Strategic Exit Plan Starts with Action
            </p>
            <p>The Portugal Golden Visa is a powerful mobility and security tool - but change is coming. Take action now to secure EU residency before costs rise or laws shift.</p>

            <div className="mt-6 p-6 bg-[#F5F5F5] rounded-lg shadow-md">
              <p className="font-semibold flex items-center gap-2 text-base text-[#002741] mb-4">
                <AlertTriangle className="w-5 h-5 text-[#B4A77E]" /> Live Q&A Webinar - Limited Spots Available
              </p>
              <ul className="space-y-2 text-sm">
                <li className="flex items-start gap-2">
                  <BadgeCheck className="w-4 h-4 text-[#B4A77E] mt-1" /> How the Portugal Golden Visa works in 2025
                </li>
                <li className="flex items-start gap-2">
                  <BadgeCheck className="w-4 h-4 text-[#B4A77E] mt-1" /> Investment fund routes starting at €500,000
                </li>
                <li className="flex items-start gap-2">
                  <BadgeCheck className="w-4 h-4 text-[#B4A77E] mt-1" /> Legal process, timeline, and how to get “grandfathered in”
                </li>
                <li className="flex items-start gap-2">
                  <BadgeCheck className="w-4 h-4 text-[#B4A77E] mt-1" /> New fund options with strategic exposure and compliance
                </li>
                <li className="flex items-start gap-2">
                  <BadgeCheck className="w-4 h-4 text-[#B4A77E] mt-1" /> Tax planning including NHR phase-out and alternatives
                </li>
              </ul>
                   ...
                   <div className="pb-10">
                    ...
                    <div className="flex items-start gap-4">
                      <img
                  src="https://goldenvisashub.com/assets/images/andre.web"
                        alt="André Bandeira"
                    ...
                    <div className="flex items-start gap-4">
                      <img
                 src="https://goldenvisashub.com/assets/images/maria.web"
