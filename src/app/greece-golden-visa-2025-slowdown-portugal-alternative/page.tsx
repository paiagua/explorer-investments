...
import { Globe, BarChart, TrendingDown, Landmark, ShieldCheck, Compass, Star } from 'lucide-react';
      ...
      <section className="bg-white text-[#002741] px-4 sm:px-6 py-12 sm:py-16 max-w-screen-xl mx-auto">
        <div className="max-w-3xl mx-auto space-y-10">
          ...
          <section id="slowdown" className="space-y-4">
            <h2 className="text-2xl font-bold text-[#002D3D] flex items-center gap-2"><TrendingDown className="text-[#B4A77E]" /> Greece’s Slowdown and the 2025 Data Shock</h2>
            <p>
